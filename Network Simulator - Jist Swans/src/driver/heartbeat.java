...
public class heartbeat
{
  ...
  /** Nam Trace file support is on or off?*/
  private static boolean animatorTrace=false;
      ...
      PacketLoss plIn, PacketLoss plOut)
  {
    ...
    NetIp net = new NetIp(new NetAddress(i), protMap, plIn, plOut, field.getTrace());
  ...
  public static Field createSim(int nodes, int length)
  {
    ...
    if(animatorTrace)
    {
    	JavisTrace.createTraceSetTrace(field,"heartbeat_"+nodes+"_NodeSim");
    }
