   ...
   try
    {
      ...
      JavisTrace.createTraceSetTrace(field,"dsrtestSim");
      ...
      // net
      NetIp net1 = new NetIp(new NetAddress(SERVER_IP), protMap, pl, pl,field.getTrace());
      NetIp net2 = new NetIp(new NetAddress(i), protMap, pl, pl, field.getTrace());
      // route
   ...
   try
    {
      ...
      NetIp net1 = new NetIp(new NetAddress(SERVER_IP), protMap, pl, pl,field.getTrace());
      NetIp net2 = new NetIp(new NetAddress(i), protMap, pl, pl,field.getTrace());
      NetIp net3 = new NetIp(new NetAddress(i+1), protMap, pl, pl,field.getTrace());
      // route
      RouteDsr dsr1 = new RouteDsr(net1.getAddress());
      RouteDsr dsr2 = new RouteDsr(net2.getAddress());
