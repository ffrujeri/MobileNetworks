...
public final class Constants
{
  ...
  static {
	  double alpha = 2.0;    double beta = 1.0;
  	  ...
  	  betaUniform = new BetaGen(stream, betaDist);
  }
  
  public static double exprnd(double m1){
	  ExponentialDist exponentialDist = new ExponentialDist(m1);
	  esponencial = new ExponentialGen(stream,exponentialDist);
	  return ExponentialGen.nextDouble(stream, 1.0/m1) ;
  }
  ...
  public static final int PLACEMENT_RANDOM_CIRCLE    = 3;
  /** node placement choice constant. */
  ...
  /** node mobility choice constant. */
  public static final int MOBILITY_DIRECTION = 5;
  /** node mobility choice constant. */
  public static final int MOBILITY_BOUNDLESS_SIM_AREA = 6;
  public static final int MOBILITY_UNIFORM_CIRCLE = 7;
  
  public static final int MOBILITY_UNIFORM_RECT = 8;
  ...
  public static final double SENSITIVITY_DEFAULT = -62.0;     // cerca de 70m de raio //era esse .... -91.0;
  // original
  //  /** Default radio reception threshold (units: dBm). */
  //  public static final double THRESHOLD_DEFAULT = -81.0;
  /** Default radio reception threshold (units: dBm). */
  public static final double THRESHOLD_DEFAULT = -81.0; // For example, THRESHOLD_DEFAULT=-72 gave me a transmit range of 220m, 
