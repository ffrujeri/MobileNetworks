@set CP=..\libs\bcel.jar;..\libs\bsh.jar;..\libs\jargs.jar;..\libs\log4j.jar;..\libs\colt.jar;..\libs\ssj.jar;..\libs\optimization.jar;..\libs\jython.jar;.
@set OPT=-g -source 1.5 -classpath %CP%
